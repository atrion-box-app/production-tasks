...
def load_assignments_from_sheet():
    ...
    try:
        ...
        for r in records:
            ...
            # --- FIX: Check both Assigned_Date and Assigned_Done ---
...
def get_project_details(project_name, procurement_df, tasks_database, incoming_df):
    ...
    if not incoming_df.empty:
        ...
        if not project_row.empty:
            ...
            if "OK SHIPPED" in shipping_status or "OK SHIPPED" == shipping_status:
                is_shipped = True
...
def render_dashboard(procurement_df, tasks_database, team_database, availability_database, incoming_df):
    ...
    # Filter active projects (not shipped)
    active_projects = []
    ...
    c1.metric("Ενεργά Projects", len(active_projects))
